...
public class UserConnection implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6117499690736007988L;
    ...
    @Id
    @Column(name = "Provideruserid", length = 64, nullable = false)
    ...
    @Column(name = "Profileurl", length = 255, nullable = true)
    private String profileUrl;
 
    @Column(name = "Imageurl", length = 255, nullable = true)
    private String imageUrl;
 
    @Column(name = "Accesstoken", length = 255, nullable = true)
